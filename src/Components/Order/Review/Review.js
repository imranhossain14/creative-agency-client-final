...
const Review = () => {
  ...
  const onSubmit = data => {
      fetch('https://nameless-shelf-27185.herokuapp.com/addReviews',{
          method: 'POST',
    ...
    return (
        ...
        <div className="row mt-5 text-left " >
            <div   className="col-md-2 mb-5 pb-5 ml-5 pl-5 ">
                ...
                <IconButton><TextsmsIcon  style={{color:"#009444"}}/>  </IconButton>
                Review
                </h6>
                </Link>
            </div>
            ...
            <form  className="w-75 sm-form" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <button type="submit" className="text-white btn btn-lg btn-dark btn-outline-danger">Send</button>
                </form>
